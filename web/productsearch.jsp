                    ...
                    <div class="grid-product">
                        ...
                        <c:forEach var="product" items="${productList}">
                            <div class="  product-grid">
                                <div class="content_box"><a href="ProductViewServlet?MSSP=${product.getMSSP()}">
                                ...
                                <h4><b><a href="ProductViewServlet?MSSP=${product.getMSSP()}">TÊN SẢN PHẨM: ${product.getTenSanPham()}</a></b></h4>
